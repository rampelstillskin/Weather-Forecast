  ...
  return (
    <div className="weather-card">
      ...
      <p className="weather-card__currently">
        {icon ? (
          <img src={icon} alt="" className="weather-card__currently-icon" />
        ) : null}
        {currentTemperature ? <span>{roundingTemperature}°</span> : null}
      </p>
      ...
      {humidity ? (
        <p className="weather-card__list-data">
          ...
          <span className="weather-card__item-data">Влажность: {humidity}</span>
          <br />
